
{
    ...
    TGraph *gr_m1 = new TGraph("result_RID157_-1,0.csv.root.txt", "%lg %*lg %*lg %*lg %*lg %*lg %*lg %*lg %lg");
    TGraph *gr_m05 = new TGraph("result_RID157_-0.5,0.csv.root.txt", "%lg %*lg %*lg %*lg %*lg %*lg %*lg %*lg %lg");
    TGraph *gr_1 = new TGraph("result_RID157_1,0.csv.root.txt", "%lg %*lg %*lg %*lg %*lg %*lg %*lg %*lg %lg");
    TGraph *gr_05 = new TGraph("result_RID157_0.5,0.csv.root.txt", "%lg %*lg %*lg %*lg %*lg %*lg %*lg %*lg %lg");
