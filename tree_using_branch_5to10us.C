...
#include <string>
{
    ...
    int line_no = 0;
    double sampling_time_data, output_sampling_time;
    ...
    do
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            // {
            //     stringstream linestream(strContents);
            //     std::getline(linestream, strtmp, ',');
            //     std::getline(linestream, strtmp, ',');
            //     sampling_time_data = strtmp.Atof();
            // }
        }
        // cout << sampling_time_data << endl;
        //return 0;
        // TTreeを作成する
